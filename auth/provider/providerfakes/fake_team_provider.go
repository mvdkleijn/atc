...
type FakeTeamProvider struct {
	...
	AddAuthGroupStub        func(*flags.Parser) provider.AuthConfig
...
func (fake *FakeTeamProvider) AddAuthGroup(arg1 *flags.Parser) provider.AuthConfig {
...
func (fake *FakeTeamProvider) AddAuthGroupArgsForCall(i int) *flags.Parser {
	fake.addAuthGroupMutex.RLock()
	defer fake.addAuthGroupMutex.RUnlock()
